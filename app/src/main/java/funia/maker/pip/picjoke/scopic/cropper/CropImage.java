...
package funia.maker.pip.picjoke.scopic.cropper;
...
import funia.maker.pip.picjoke.scopic.activity.CropImageActivity;
...
public final class CropImage {
    ...
    public static final class ActivityBuilder {
         ...
         */
        public Intent getIntent(@NonNull Context context, Image imageInfo) {
            return getIntent(context, CropImageActivity.class, imageInfo);
        }

        /**
         * Get {@link CropImageActivity} intent to start the activity.
         */
        public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls, Image imageInfo) {
            mOptions.validate();
...
//            intent.putExtra("Image", imgFrame);
         ...
         */
        public void start(@NonNull Activity activity, Image image) {
            mOptions.validate();

            activity.startActivity(getIntent(activity, image));
        }
